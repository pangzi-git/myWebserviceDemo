...
public class DES {
	...
	private static final String Algorithm = "DESede"; // 定义 加密算法,可用
														// DES,DESede,Blowfish
	private static final String paramArrayOfByte = "111111111111111111111111";
	...
	public static void main(String[] args) {
		...
		byte[] encoded = encryptMode(paramArrayOfByte.getBytes(), szSrc.getBytes());
		System.out.println("加密后的字符串:" + new String(encoded));

		byte[] srcBytes = decryptMode(paramArrayOfByte.getBytes(), encoded);
